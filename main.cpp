 ...
 int WINAPI WinMain(HINSTANCE hInstance , HINSTANCE, PSTR szCmdLine , int nCmdShow)
{
    ...
    WNDCLASSEX wndClass = {};//必须初始化,wndclass除了一下成员都可以初始化为0
    ...
    auto hWnd = CreateWindowEx(0,szWndClassName,TEXT("window name"),WS_SYSMENU|WS_CAPTION|WS_MINIMIZEBOX,0,0,800,600,NULL,NULL,hInstance,0);
    MSG msg;
